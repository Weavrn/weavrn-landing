      ...
      {hasAnyHandle && (
        <div className="border border-weavrn-border/30 rounded-xl p-5 text-xs text-weavrn-muted/70 space-y-3">
          ...
          <div className="space-y-2 leading-relaxed">
            <p><span className="text-weavrn-muted">Eligibility.</span> X accounts must have at least 50 followers. YouTube channels must have at least 25 subscribers. Content must mention weavrn, $WVRN, #WVRN, @weavrn, weavrn.com, or weavrn.ai to qualify. Only content created after you link your account is eligible.</p>
            <p><span className="text-weavrn-muted">X Scoring.</span> Engagement score = (likes &times; 1) + (retweets &times; 3) + (replies &times; 2) + (views &times; 0.01). Posts must reach a minimum engagement score of 10 to qualify.</p>
            <p><span className="text-weavrn-muted">YouTube Scoring.</span> Engagement score = (likes &times; 1) + (comments &times; 2) + (views &times; 0.01). Videos must mention weavrn or $WVRN in the title or description.</p>
            <p><span className="text-weavrn-muted">Rewards.</span> Block emission is split between X (70%) and YouTube (30%) pools, then divided proportionally by effective score within each pool. Effective score uses diminishing returns: sqrt(score) &times; 100. No single user can earn more than 50% of a block&apos;s emission. A maximum of 10 qualifying posts per user are counted per block.</p>
